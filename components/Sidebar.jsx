  ...
  return (
    <div className='flex flex-col justify-between p-3 h-screen'>
      <div className='flex flex-col gap-4'>
        <Link href='/'>
          <FaXTwitter className='h-16 w-16 cursor-pointer p-3 hover:bg-gray-100 dark:hover:bg-[#1a1a1a] rounded-full transition-all duration-200' />
        </Link>
        <div className='flex flex-col gap-y-2'>
          <Link href='/' className='flex items-center p-3 hover:bg-gray-100 dark:hover:bg-[#1a1a1a] rounded-full transition-all duration-200 gap-2 w-fit'>
      ...
      {
        session && (
          <div className='text-gray-700 dark:text-gray-200 text-sm flex items-center cursor-pointer p-3 hover:bg-gray-100 dark:hover:bg-[#1a1a1a] rounded-full transition-all duration-200'>
            <img src={session.user.image} alt="user-img" className='w-10 h-10 rounded-full xl:mr-2' />
            <div className='hidden xl:inline'>
              <h4 className='font-bold'>{session.user.name}</h4>
              <p className='text-gray-500 dark:text-gray-400'>@{session.user.username}</p>
            </div>
