...
const Sidebar = () => {
  return (
    <div className='flex flex-col gap-4 p-3'>
      ...
      <button className='bg-blue-400 text-white font-bold rounded-full mt-4 hover:brightness-95 hover:bg-blue-600 transition-all duration-200 w-48 h-9 shadow-md cursor-pointer hidden xl:inline'>Sign In</button>
    </div>
  )
}
